...
import biz.alsheimer.vmcontract.security.*;
import biz.alsheimer.vmcontract.security.SecurityUtils;
import biz.alsheimer.vmcontract.security.oauth2.AudienceValidator;
import biz.alsheimer.vmcontract.security.oauth2.CustomClaimConverter;
import biz.alsheimer.vmcontract.security.oauth2.JwtGrantedAuthorityConverter;
import biz.alsheimer.vmcontract.web.filter.SpaWebFilter;
import java.util.*;
