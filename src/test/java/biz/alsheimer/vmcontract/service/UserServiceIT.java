package biz.alsheimer.vmcontract.service;
...
import biz.alsheimer.vmcontract.IntegrationTest;
import biz.alsheimer.vmcontract.config.Constants;
import biz.alsheimer.vmcontract.domain.User;
import biz.alsheimer.vmcontract.repository.UserRepository;
import biz.alsheimer.vmcontract.repository.search.UserSearchRepository;
import biz.alsheimer.vmcontract.security.AuthoritiesConstants;
import biz.alsheimer.vmcontract.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the biz.alsheimer.vmcontract.repository.search test package.
     *
     * @see biz.alsheimer.vmcontract.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
